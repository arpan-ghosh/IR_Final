...
def main(argv):
 ...
 python Exporter.py --username "barackobama" --maxtweets 10 --toptweets\n"""
	...
	try:
		...
		outputFile = codecs.open("clinton_nov_2016.csv", "w+", "utf-8")
		
		outputFile.write('text,id,\n')
		...
		def receiveBuffer(tweets):
			...
			for t in tweets:
				...
				#outputFile.write(('%s' % (t.id)))
				#outputFile.write('\n')
				#outputFile.write(('%s' % (t.text)))
			outputFile.flush();
		...
		outputFile.close()
		print 'Done. Output file generated "clinton_nov_2016.csv".'
